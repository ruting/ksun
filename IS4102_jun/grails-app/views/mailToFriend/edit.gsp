...
<html>
	...
	<body>
		<a href="#edit-mailToFriend" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="edit-mailToFriend" class="content scaffold-edit" role="main">
			...
			<g:form method="post" >
				...
				<g:hiddenField name="version" value="${mailToFriendInstance?.version}" />
				<fieldset class="form">
