...
(function($) {
    $.fn.formToWizard = function( options, cmdParam1 ) {
        ...
        if( typeof options !== 'string' ) {
            ...
            if( options.showProgress ) {
                if( options.showStepNo )
                    ...
                    $(element).before("<ul id='steps' class='steps bread'></ul>");
            }
        ...
        function createPrevButton(i) {
            var stepName = "step" + i;
            $("#" + stepName + "commands").append("<a href='#' id='" + stepName + "Prev' class='prev btn btn-inverse btn-large'><i class='icon-white icon-chevron-left'></i> " + options.prevBtnName + "</a>");
        ...
        function createNextButton(i) {
            var stepName = "step" + i;
            $("#" + stepName + "commands").append("<a href='#' id='" + stepName + "Next' class='next btn btn-inverse btn-large'>" + options.nextBtnName + " <i class='icon-white icon-chevron-right'></i> </a>");
